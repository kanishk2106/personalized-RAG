...
type Profile = "strict" | "balanced" | "off";
...
type Classifier = (text: string, ctx: {
    sink: Sink;
...
type ChatRole = "system" | "user" | "tool";
...
export type { ChatMessage as C, InspectReport as I, MessageParts as M, NormalizationReport as N, Profile as P, Risk as R, Sink as S, TripwireRule as T, ChatRole as a, Classifier as b, ClassifierResult as c, PurifyConfig as d };
